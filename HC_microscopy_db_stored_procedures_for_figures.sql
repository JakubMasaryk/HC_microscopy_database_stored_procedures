...
-- used to create a supplemetary table 'Fig.3_supp_table_enrichments' sheet 'clusters_proteins'
drop procedure if exists hc_microscopy_data_v2.hits_labels;
delimiter //
create procedure hc_microscopy_data_v2.hits_labels()
begin
	with
...
call hc_microscopy_data_v2.hits_labels();
